...
class _DashboardState extends State<ContactPage> {
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('contacts').doc(globals.docs[index]).update(data);
...
const fieldNames = [
  "First Name", "Last Name", "Company Name", "Job Title", "Business Type", "Email Address", "Phone Number", "Alternate Phone Number", "Fax Number", "Website"
,"Notes"
