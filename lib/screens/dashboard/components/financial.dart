...
class _DashboardState extends State<FinancialPage> {
  ...
  void getUrl() async {
    CollectionReference users = FirebaseFirestore.instance.collection('financial');
    globals.data = [];
    globals.docs = [];
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('financial').doc(globals.docs[index]).update(data);
...
const fieldNames = [
  "BFID", "Account Number", "Bank Account Type -- BAT", "Bank Name", "Account Holder Name", "Account Holder Address", "Account Status", "Opening Date", "Balance", "Available Balance", "Interest Rate", "Overdraft Protection", "Debit Card Information", "Checkbook Information", "Routing Number", "SWIFT/BIC Code", "Transaction History (Date, Description, Amount, Type)", "Account Statements", "Account Notes", "Account Alerts", "Linked Accounts", "Online Banking Credentials (Username, Password)", "PIN (Personal Identification Number)", "Beneficiary Information", "Account Closure Date", "Tax Information", "Account Holder Contact Information (Phone number, Email address)", "Privacy Preferences", "Security Questions/Answers"
