...
class NonTangibleAssetPage extends StatefulWidget {
  @override
  _DashboardState createState() => _DashboardState();
}

class _DashboardState extends State<NonTangibleAssetPage> {
  ...
  void getUrl() async {
    CollectionReference users = FirebaseFirestore.instance.collection('nontangibleassets');
    globals.data = [];
    globals.docs = [];
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('nontangibleassets').doc(globals.docs[index]).update(data);
...
const fieldNames = [
  "Asset ID", "Asset Name/Description", "Asset Type", "Serial Number/VIN", "Purchase Date", "Purchase Price", "Current Value", "Depreciation Method", "Depreciation Rate", "Estimated Useful Life", "Location", "Condition", "Maintenance History (Date, Description, Cost)", "Warranty Information", "Insurance Information", "Resale Value", "Disposal Date", "Notes", "Photos", "User Manual/Documents", "Maintenance Schedule", "Service Records (Date, Description, Cost)", "Ownership Information", "Financial Information (Financing, Interest Rates)", "Registration/Title Information", "Licensing/Permit Information", "User/Operator Information", "Location History"
