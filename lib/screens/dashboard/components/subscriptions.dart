...
class _DashboardState extends State<SubscriptionPage> {
  ...
  void getUrl() async {
    CollectionReference users = FirebaseFirestore.instance.collection('subscriptions');
    globals.data = [];
    globals.docs = [];
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('subscriptions').doc(globals.docs[index]).update(data);
