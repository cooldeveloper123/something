...
class MortageClosingPage extends StatefulWidget {
  @override
  _DashboardState createState() => _DashboardState();
}

class _DashboardState extends State<MortageClosingPage> {
  ...
  void getUrl() async {
    CollectionReference users = FirebaseFirestore.instance.collection('mortage_closing');
    globals.data = [];
    globals.docs = [];
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('mortage_closing').doc(globals.docs[index]).update(data);
