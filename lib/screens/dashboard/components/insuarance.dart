...
class InsuarancePage extends StatefulWidget {
  @override
  _DashboardState createState() => _DashboardState();
}

class _DashboardState extends State<InsuarancePage> {
  ...
  void getUrl() async {
    CollectionReference users = FirebaseFirestore.instance.collection('insuarance');
    globals.data = [];
    globals.docs = [];
                                                                              ...
                                                                              SizedBox(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      await FirebaseFirestore.instance.collection('insuarance').doc(globals.docs[index]).update(data);
...
const fieldNames = [
  "Policyholder Name", "Type", "Number", "Company", "Start Date", "End Date", "Coverage Details", "Premium Amount", "Payment Frequency", "Payment Due Date", "Documents", "Notes", "website", "Contact Number", "Insurance Agent Name", "Insurance Agent Company", "Insurance Agent Email", "Insurance Agent 2 email", "My email", "My contact number"
